...
public class AlignToTarget extends Command {
  ...
  @Override
  public void execute() {
    // aveLidarDist = (alignVision.getRightLidarDistance() + alignVision.getLeftLidarDistance()) /
    // 2;
    // diffLidarDist = alignVision.getRightLidarDistance() - alignVision.getLeftLidarDistance();
    // refPosition = alignVision.getReferenceRobotPosition();
    ...
    swerve.driveRobotRelative(alignVision.getAlignChassisSpeeds());
  }
}
