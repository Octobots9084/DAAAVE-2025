...
public class AlignVision extends SubsystemBase {
     ...
     */
    private final int[] blueAlignAngles = { 0, 60, 120, 180, -120, -60, -90, 54, -54 };
    private final int[] redAlignAngles = { 180, 240, 300, 0, 60, 120, 90, -126, 126 };
    ...
    private double calculateXSpeed(double aveLidarDist, Pose3d refPosition, AlignState state,ReefTargetSide targetSide) {
        ...
        } else if (selectedPoleSide == ReefTargetSide.ALGAE){ // If no lidars are valid, then use the camera distance to calculate the x speed
            isCollecting = false;
