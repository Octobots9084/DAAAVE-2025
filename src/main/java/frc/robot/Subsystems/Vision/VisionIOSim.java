...
public class VisionIOSim implements VisionIO {
    ...
    PhotonCameraSim cameraSim = new PhotonCameraSim(frontLeftCamera.getCameraObject(), cameraProp);
    ...
    new Notifier(
        ...
        public VisionIOSim() throws IOException {
            ...
            // example camera is mounted 0.1 meters forward and 0.5 meters up from the robot pose,
